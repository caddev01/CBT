...
<?php 
   ...
   $query = "UPDATE subject(sname, noq) ";
   $query .= " VALUES()" 
?>
		...
		<div class="container">
           ...
           <!-- subject navigation -->
                 <h1 style="text-align: center;margin-bottom: 20px;">
					<a href="nav_subject.php"><span class="label label-primary">Create Subject</span></a>
					<a href="edit_subject.php"><span class="label label-success">Manage Subject</span></a>
				</h1>
...
<!-- search students bar -->
		...
		<!--edit subject form -->
			<form action="nav_subject.php"  method="POST">
			<div class="input-group">
			...
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1">No of Questions</span>
				<input type="text" class="form-control" name="noq" value="" aria-describedby="basic-addon1">
			</div>
