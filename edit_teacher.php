...
<?php 
   ...
   $query = "UPDATE teacher SET surname='$sname', fname='$fname', class_id=$class,t_pwd='$ppword', username='$search' WHERE t_id=$sid ";
...
<!-- admin navigation -->
                 ...
                 <h1 style="text-align: center;margin-bottom: 20px;">
					<a href="nav_teacher.php"><span class="label label-primary">Create Student</span></a>
					<a href="edit_teacher.php"><span class="label label-success">Manage Student</span></a>
				</h1>
<!-- search students bar -->
                  <form>
