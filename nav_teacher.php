...
<?php 
   ...
   $query = "INSERT INTO teacher(surname, fname, username, t_pwd, class_id) ";
   $query .=" VALUES('{$sname}', '{$fname}', '{$usname}', '{$pword}', '{$class}')" ;
...
<!-- admin navigation -->
                 <h1 style="text-align: center;margin-bottom: 20px;">
					<a href="nav_teacher.php"><span class="label label-primary">Create Teacher</span></a>
					<a href="edit_teacher.php"><span class="label label-success">Manage Teacher</span></a>
				</h1>
<!--add student form -->
			<form action="nav_teacher.php"  method="POST">
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1">Surname</span>
				<input type="text" class="form-control" name="sname" value="" aria-describedby="basic-addon1">
			</div>
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1">Firstname</span>
				<input type="text" class="form-control" name="fname" value="" aria-describedby="basic-addon1">
			</div>
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1">Username</span>
				<input type="text" class="form-control" name="usname" value="" aria-describedby="basic-addon1">
			</div>
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1">Password</span>
				<input type="Password" class="form-control" name="pword" value="" aria-describedby="basic-addon1">
			</div>
			<div class="input-group">
				<input type="text" class="form-control" name="class" value="" aria-describedby="basic-addon2">
