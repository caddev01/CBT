...
<?php 
   if(isset($_GET["passkey"])){
   	$search = $_GET["passkey"];
   	$query = "SELECT*FROM class WHERE cName = '{$search}'";
   	$result = mysqli_query($connection, $query);
   	$result_set = mysqli_fetch_array($result);
   	$sname = $result_set['cName'];
   	$sid = $result_set['cid'];
      }
   ...
   $query = "UPDATE class SET cName='$sname' WHERE cid=$sid ";
...
<!-- search students bar -->
                  <form>
                   <div class="input-group">
						...
						<input type="text" class="form-control" value="" name="passkey" placeholder="Search Class name...">
					</div>
                    </form>
					<!-- /input-group -->				
<!--add student form -->
