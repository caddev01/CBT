		...
		<div class="container">
           ...
           <!-- Result navigation -->
                 <h1 style="text-align: center;margin-bottom: 20px;">
					<a href="nav_result.php"><span class="label label-primary">Create Result</span></a>
					<a href="edit_result.php"><span class="label label-success">Manage Result</span></a>
				</h1>

<!--add Result form -->
			<form action="nav_result.php"  method="POST">
			...
			<div class="input-group">
				...
				<input type="text" class="form-control" name="score" value="" aria-describedby="basic-addon1">
			</div>
