...
<?php require("includes/credentials.php") ?>
<?php confirm_logged_in(); ?>
<?php 
   if(isset($_GET["passkey"])){
   	$search = $_GET["passkey"];
   	$query = "SELECT*FROM student WHERE username = '{$search}'";
   	$result = mysqli_query($connection, $query);
   	$result_set = mysqli_fetch_array($result);
   	$sname = $result_set['surname'];
   	$fname = $result_set['fname'];
   	$uuname = $result_set['username'];
   	$ppword = $result_set['s_pwd'];
   	$class = $result_set['class_id'];
   	$sid = $result_set['s_id'];
      }
    ...
    if(isset($_POST["submit"])){
   	$sname =$_POST["sname"];
   	$fname =$_POST["fname"];
   	$search =$_POST["usrname"];	
   	$ppword =$_POST["ppword"];
   	$class = $_POST["class"]; 
   	$sid =  $_POST["sid"];   
   

   $query = "UPDATE student SET surname='$sname', fname='$fname', class_id=$class,s_pwd='$ppword', username='$search' WHERE s_id=$sid ";
   $results = mysqli_query($connection, $query);
   if(isset($results)){echo "done!";}
    }
?>
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						<nav class="menu menu--shylock">
							...
							<ul class="nav navbar-nav">
								...
								<li><a href="dashboard.php" class="hvr-bounce-to-bottom">Admin</a></li>
...
<!-- admin navigation -->
                 ...
                 <h1 style="text-align: center;margin-bottom: 20px;">
					<a href="nav_student.php"><span class="label label-primary">Create Student</span></a>
					<a href="edit_student.php"><span class="label label-success">Manage Student</span></a>
				</h1>
<!-- search students bar -->
                  <form>
                   <div class="input-group">
						<span class="input-group-btn">
							<input type="submit" value="Go!" class="btn btn-default" >Go!</input>
						</span>
						<input type="text" class="form-control" value="" name="passkey" placeholder="Search username...">
					</div>
                    </form>
					<!-- /input-group -->				
<!--add student form -->
			...
			<div class="input-group">
				...
				value="<?php if(isset($sname)){echo $sname;} ?>"
			...
			<div class="input-group">
				...
				<input type="text" class="form-control" name="ppword" 
				value="<?php if(isset($ppword)){echo $ppword;} ?>"
				 aria-describedby="basic-addon1">
			</div>
			<div class="input-group">
				<input type="text" class="form-control" name="class" 
				value="<?php if(isset($class)){echo $class;} ?>"
