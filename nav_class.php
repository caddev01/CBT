...
<!-- admin navigation -->
                 <h1 style="text-align: center;margin-bottom: 20px;">
					<a href="nav_class.php"><span class="label label-primary">Create Class</span></a>
					<a href="edit_class.php"><span class="label label-success">Manage Class</span></a>
				</h1>
<!--add student form -->
			<form action="nav_class.php"  method="POST">
			<div class="input-group">
				<span class="input-group-addon" id="basic-addon1">Class</span>
				<input type="text" class="form-control" name="class" value="" aria-describedby="basic-addon1">
			</div>
